          ...
          <div class="card-body">
            ...
            <form action="{{ route('books.store') }}" method="POST">
              ...
              <div class="mb-3">
                ...
                <input type="text" name="pengarang" id="pengaran" class="form-control" placeholder="Masukkan nama penulis" required>
              </div>
              ...
              <div class="mb-3">
                ...
                <input type="number" name="tahun_terbit" id="tahun_terbit" class="form-control" placeholder="Contoh: 2024" required>
              </div>

               <div class="mb-3">
                <label for="tahun_terbit" class="form-label">stok</label>
